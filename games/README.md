...
Each machine must be funded with enough MATIC to pay out any potential winnings plus enough LINK to request random numbers before play is available. Once play is enabled, any player with an Ethereum address can place a bet through the provided UI or through direct contract interaction. 
...
Currently running on Polygon / Matic Mainnet at https://polygon.luckymachines.io
